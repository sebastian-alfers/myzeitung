...
class PapersController extends AppController {
	...
	function subscribe($paper_id){
		if(isset($paper_id)){
			if($this->Paper->subscribe($paper_id, $this->Auth->user('id'))){
				$this->Session->setFlash(__('Successfully subscribed paper.', true));
			}
			else{
				$this->Session->setFlash(__('Error while subscribing Paper', true));
			}
		}else {
			if(!isset($paper_id)){
				// no paper id
	...
	function unsubscribe($paper_id){
		if(isset($paper_id)){
			if($this->Paper->unSubscribe($paper_id, $this->Auth->user('id'))){
				$this->Session->setFlash(__('Successfully unsubscribed to paper', true));
			}
			else{
				$this->Session->setFlash(__('Error while unsubscribing to paper', true));
			}
		}
		else {
			// no paper $id
