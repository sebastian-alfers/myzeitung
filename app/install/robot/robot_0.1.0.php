...
$sql[] = "CREATE TABLE `robot_task_actions`(
    `id` CHAR(36) NOT NULL,
...
$sql[] = "ALTER TABLE `robot_task_actions`
    ADD UNIQUE KEY `action`(`action`);";

$sql[] = "ALTER TABLE `robot_tasks`
...
$log = 'addded tables for mr roboto';
