...
var simpleGallery_navpanel={
	...
	images: [ '/img/assets/left.gif', '/img/assets/play.gif', '/img/assets/right.gif', '/img/assets/pause.gif'], //nav panel images (in that order)
...
simpleGallery.routines={
	...
	getSlideHTML:function(imgelement){
		var layerHTML=(imgelement[1])? '<a href="'+imgelement[1]+'"  rel="gallery" class="pirobox_gall" rev="1">\n' : '' //hyperlink slide?
