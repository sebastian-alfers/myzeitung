...
(function($) {
    $.fn.spinner = function(options) {
        ...
        return this.each(function() {
            ...
            $s = $('<div id="waiting-status-msg" style="position: absolute; left: ' + (parseInt(l)-20) +'px; top: ' + t + '; width:200px; height: ' + opts.height + 'px; z-index: ' + opts.zIndex + ';"><img src="' + opts.img + '" style="position:relative;top:4px;padding:0 0 0 6px;" /></div>').appendTo('body');
    ...
    $.fn.spinner.defaults = {
        ...
        , img       : '/img/assets/spinner.gif' // path to spinner img
