...
(function(tinymce) {
    ...
    //alert('gaga ' + tinymce.documentBaseURL);
    //alert('before ' + tinymce.baseURL);
	tinymce.baseURL = new tinymce.util.URI(tinymce.documentBaseURL).toAbsolute(tinymce.baseURL);
    //alert('after ' + tinymce.baseURL);

    //tinymce.baseURL = 'http://localhost:8180/js/tiny_mce';

    /***************** custom start *************************************/
    tinymce.baseURL = base_url + '/js/tiny_mce';
    /***************** custom  end  *************************************/
	tinymce.baseURI = new tinymce.util.URI(tinymce.baseURL);

    //alert('a' + tinymce.documentBaseURL);
    //alert('b' + tinymce.baseURL);
    //alert('c' + tinymce.baseURI);
