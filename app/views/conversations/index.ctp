							...
							<li class="message">
								<ul>
									...
									<li class="message-info">
                                		...
                                		<p class="excerpt"><?php echo $this->Html->link(substr($conversation['Conversation']['LastMessage']['message'],0,165).'...',array('controller' => 'conversations', 'action' => 'view', $conversation['Conversation']['id']));?></p>
									</li>
									<li class="actions">
