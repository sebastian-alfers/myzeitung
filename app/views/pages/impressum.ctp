<div id="maincolwrapper" class="onecol">
	<div id="maincol">
        <h2>Impressum</h2>
<p class="p1">Betreiber von myZeitung.de:</p>
<p class="p2">&nbsp;</p>
<p class="p1">OTS WebWorks UG i.Gr.</p>
<p class="p1">Pritchardstr. 9</p>
<p class="p1">14169 Berlin</p>
<p class="p2">&nbsp;</p>
<p class="p1">Vertretungsberechtigte Gesch&auml;ftsf&uuml;hrer:</p>
<p class="p1">Sebastian Alfers, Tim Wiegard, Otto Schulz</p>
<p class="p2">&nbsp;</p>
