    ...
    <div class="leftcolcontent">
        ...
        */ ?>
        ...
        <ul class="filter-search">
             ...
             <?php echo $this->Paginator->sort('<span class="icon icon-date"></span>'. __('Date', true), 'created', array('escape' => false)); ?></li>

             <?php if(in_array($this->Paginator->sortKey(), array('Post.view_count', 'Post.view_count ASC', 'Post.view_count DESC'))):?>
             <li class="active"><?php else:?><li><?php endif;?>
             <?php echo $this->Paginator->sort('<span class="icon icon-subscription"></span>'. __('Number of views', true), 'view_count', array('escape' => false)); ?></li>

             <?php if(in_array($this->Paginator->sortKey(), array('Post.comment_count', 'Post.comment_count ASC', 'Post.comment_count DESC'))):?>
             <li class="active"><?php else:?><li><?php endif;?>
             <?php echo $this->Paginator->sort('<span class="icon icon-author"></span>'. __('Number of comments', true), 'comment_count', array('escape' => false)); ?></li>

             <?php if(in_array($this->Paginator->sortKey(), array('Post.posts_user_count', 'Post.posts_user_count ASC', 'Post.posts_user_count DESC'))):?>
             <li class="active"><?php else:?><li><?php endif;?>
             <?php echo $this->Paginator->sort('<span class="icon icon-repost"></span>'. __('Number of reposts', true), 'posts_user_count', array('escape' => false)); ?></li>
