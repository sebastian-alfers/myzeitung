<div id="leftcolwapper">
    <div class="leftcol">
        ...
        <ul class="filter-search">
           <?php  debug($this->Paginator->sortKey()); ?>
            <?php if(in_array($this->Paginator->sortKey(), array('User.content_paper_count'))):?>
