			<h6><?php echo __('Activity', true);?></h6>
			  <ul>
                ...
                <li><?php echo sprintf(__n('%d comment', '%d comments', $user['User']['comment_count'],true), $user['User']['comment_count']);?></li>
		   		<li><a id="show-subscribers" href="#show-subscribers" title="users/references/<?php echo $user['User']['id']; ?>"><?php echo sprintf(__n('%d subscriber', '%d subscribers', $user['User']['subscriber_count'],true), $user['User']['subscriber_count']);?></a></li>
