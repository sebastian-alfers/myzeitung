...
<?php echo $this->MzTime->format('d.m.y G:i', $comment['Comment']['created']);?>
 &nbsp;<?php echo $this->Html->link($commentator['User']['username'], $this->Html->url(array('controller' => 'users', 'action' => 'view', 'username' => strtolower($commentator['User']['username']))),array('style' => 'color:#232424; font-weight:bold;')); ?>
<br />
