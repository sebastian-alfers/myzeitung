...
class CksourceHelper extends FormHelper {
	...
	function ckeditor($fieldName, $options = array()) {
		if(!isset($options['config'])){
			$default_config['toolbar'] = array(
			array('Format', 'FontSize', '-' ,'Bold', 'Italic', 'Underline' , 'Strike' ),
			array('NumberedList', 'BulletedList','-','Outdent','Indent','Blockquote', '-', 'Maximize')
			//array( 'Image', 'Link', 'Unlink', 'Anchor', 'numberedlist' )
			);
