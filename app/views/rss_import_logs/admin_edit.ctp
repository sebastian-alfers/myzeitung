...
<?php echo $this->Form->create('RssImportLog');?>
	<fieldset>
		<legend><?php __('Admin Edit Rss Import Log'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('RssImportLog.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('RssImportLog.id'))); ?></li>
